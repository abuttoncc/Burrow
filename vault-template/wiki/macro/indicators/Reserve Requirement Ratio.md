...
type: Indicator
domain: macro
aliases: [RRR, 存款准备金率, reserve ratio]
created: 2026-06-11
reviewed_by: human
---

# Reserve Requirement Ratio (major banks)

The fraction of deposits major commercial banks must hold at the central bank. A primary quantity-based policy instrument's target variable.
...
- 2026-06-11 · page created from vault-template sample · reviewer: human
